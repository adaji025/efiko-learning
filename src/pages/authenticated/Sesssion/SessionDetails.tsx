    ...
    <div className="mt-[50px] lg:mt-5">
      ...
      <div className="md:w-3/4 mx-auto border mt-10 rounded-xl shadow pb-5 mx-4">
        ...
        <div className="px-4 lg:px-10 mt-3">
          <div>
            <div className="text-lg font-medium">Subject Category: </div>
            <div className="text-sm ml-2">Mathematics</div>
          </div>
          <div className="mt-5">
            <div className="text-lg font-medium">Session Description: </div>
          ...
          <div className="mt-5">
            <div className="text-lg font-medium">Learning Outcome:</div>
          ...
          <div className="mt-5 flex flex-col sm:flex-row gap-5 justify-between">
            ...
            <div>
              <div className="text-lg font-medium">Session Time: </div>
              <div className="text-sm ml-2">7:00 PM Eastern Standard Time</div>
            </div>
          </div>

          <div className="mt-5">
            <div className="text-lg font-medium">Session Charges:</div>
      ...
      <div className="mt-10 flex justify-center">
        <Button size="md" className=" bg-primary w-1/3 mx-auto">Book Session</Button>
      </div>
    </div>
  );
};
